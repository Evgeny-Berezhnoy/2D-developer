...
namespace Constants.LayersLogic
{
    public static class LayerMasks
    {
        ...
        public static readonly LayerMask PLATFORM                   = LayerMask.GetMask(LayerMask.LayerToName(Layers.PLATFORM));
        public static readonly LayerMask SURFACES                   = LayerMask.GetMask(LayerMask.LayerToName(Layers.GROUND), LayerMask.LayerToName(Layers.PLATFORM));
